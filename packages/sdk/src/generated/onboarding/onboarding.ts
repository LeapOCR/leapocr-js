...
export const getOnboarding = () => {
  /**
   * Create onboarding status for the authenticated user
  ...
  /**
   * Permanently delete onboarding status for the authenticated user
  ...
  /**
   * Get onboarding status for the authenticated user by external ID
  ...
  /**
   * Update onboarding steps and metadata for the authenticated user
