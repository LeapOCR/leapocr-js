...
export type GetPageTimeseriesGranularity = typeof GetPageTimeseriesGranularity[keyof typeof GetPageTimeseriesGranularity];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GetPageTimeseriesGranularity = {
  hour: 'hour',
  day: 'day',
  week: 'week',
  month: 'month',
